    ...
    return Builder(builder: (context) {
      ...
      return Stack(
        children: [
          ...
          Positioned(
            top: (height / 2) -
                widget.overlay!.cutOutHeight -
                widget.overlay!.borderWidth * 4,
            width: width,
            height: widget.overlay!.cutOutHeight,
            child: Center(
              widthFactor: width - (width - widget.overlay!.cutOutWidth),
              child: Text(
                widget.guideMessage ?? 'Hướng Camera về phía mã QR',
          ...
          Positioned(
            left: widget.overlay!.borderLength / 2,
